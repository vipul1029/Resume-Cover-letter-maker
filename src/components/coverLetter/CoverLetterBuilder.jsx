...
export default function CoverLetterBuilder() {
  ...
  const handleGenerate = async (data) => {
    ...
    try {
      const prompt = `Write a professional cover letter for the position of ${data.jobTitle} at ${data.companyName}. Include the following information:
      ...
      Format the letter professionally with a greeting to ${data.recipientName} and include contact information: ${data.name}, ${data.email}, ${data.phone}, ${data.location}.`;
